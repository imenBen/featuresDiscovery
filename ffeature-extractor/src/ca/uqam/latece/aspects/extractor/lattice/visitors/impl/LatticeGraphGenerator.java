...
public class LatticeGraphGenerator extends AbstractVisitor implements Visitor {
	...
	public LatticeGraphGenerator() {
		nodeIndents = new HashMap<LatticeNode,String>();
		ids = new HashMap<LatticeNode,String>();
	}
	
	public LatticeGraphGenerator(ElementPrinter printer) {
		this();
	...
	public static LatticeGraphGenerator defaultPrettyPrinter() {
		return new LatticeGraphGenerator(DEFAULT_ELEMENT_PRINTER );
	}
	
	public static LatticeGraphGenerator javaElementsLatticePrettyPrinter() {
		return new LatticeGraphGenerator(JAVA_ELEMENT_PRINTER );
